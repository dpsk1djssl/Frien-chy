...
Original file is located at
    https://colab.research.google.com/drive/1F9L_VmMoiSspYUVfNJ6IlUdeQiVFKqe4
"""
...
client = QdrantClient(
    ...
    https=False # --- SSL 오류 해결을 위한 핵심 코드 ---
)
# ------------------------------------
...
async def ask_question(request: QuestionRequest):
    ...
    try:
        ...
        # --- 수정된 부분: 상세 오류 로깅 ---
        print("!!! /ask 엔드포인트에서 오류 발생 !!!")
        traceback.print_exc() # 터미널(로그)에 상세한 오류 내용을 출력합니다.
        # ------------------------------------
        raise HTTPException(
            status_code=500,
